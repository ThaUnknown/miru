<script lang='ts'>
  ...
  import { fastPrettyBits, fastPrettyBytes, eta } from '$lib/utils'
  // https://cdn.dribbble.com/userupload/42064300/file/original-4817778f87084361d34586d977153d0d.png
      ...
      <div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12'>
        ...
        <div class='space-y-4'>
          ...
          <div class='space-y-3'>
            ...
            <Status enabled={protocols.forwarding} title='Forwarding' description='Accepting inbound connections' />
          </div>
        </div>
        <div class='space-y-4'>
