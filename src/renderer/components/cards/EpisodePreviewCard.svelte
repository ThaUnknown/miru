...
<div class='position-absolute w-400 mh-400 absolute-container bg-dark-light z-30 rounded overflow-hidden pointer d-flex flex-column'>
  <div class='image h-200 w-full position-relative d-flex justify-content-between align-items-end text-white'>
    ...
    <div class='pl-15 pb-10 material-symbols-outlined filled'>play_arrow</div>
    <div class='pr-20 pb-10 font-size-16 font-weight-medium'>{media?.duration}m</div>
  </div>
